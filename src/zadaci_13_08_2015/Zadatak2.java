...
public class Zadatak2 {
	...
	public static void main(String[] args) {
		//pravljenje novog trougla
		Triangle2D t1 = new Triangle2D(new MyPoint(2.5, 2), new MyPoint(4.2, 3), new MyPoint(5, 3.5));
		//pozivanje metoda i stampanje rezultata
		System.out.println("Povrsina trougla: " + t1.getArea());
		System.out.println("Obim trougla: " + t1.getPerimeter());
		System.out.println("Trougao sadrzi tacku 3,3? " + t1.contains(new MyPoint(3, 3)));
		System.out.println("Trougao sadrzi drugi trougao? " + t1.contains(new Triangle2D(new MyPoint(2.9, 2), new MyPoint(4, 1), new MyPoint(1, 3.4))));
		System.out.println("Trougao se ukrsta sa drugim trouglom? " + t1.overlaps(new Triangle2D(new MyPoint(2, 5.5), new MyPoint(4, -3), new MyPoint(2, 6.5))));

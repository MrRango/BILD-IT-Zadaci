...
public class Zadatak3 {
	...
	public static void main(String[] args) {
		//pravljenje novog pravougaonika
		MyRectangle2D r1 = new MyRectangle2D(2, 2, 5.5, 4.9);
		//pozivanje metoda i stampanje rezultata
		System.out.println("Povrsina pravougaonika je: " + r1.getArea());
		System.out.println("Obim pravougaonika je: " + r1.getPerimeter());
		System.out.println("Pravougaonik sadrzi tacku 3,3? " + r1.contains(3, 3));
		System.out.println("Pravougaonik sadrzi drugi pravougaonik? " + r1.contains(new MyRectangle2D(4, 5, 10.5, 3.2)));
		System.out.println("Pravougaonik se ukrsta sa drugim pravougaonikom? " + r1.overlaps(new MyRectangle2D(3, 5, 2.3, 5.4)));
	}

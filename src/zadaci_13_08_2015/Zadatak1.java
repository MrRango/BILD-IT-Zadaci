...
public class Zadatak1 {
	...
	public static void main(String[] args) {
		//pravljenje novog kruga
		Circle2D circle1 = new Circle2D(2, 2, 5.5);
		//pozivanje metoda i stampanje rezultata
		System.out.println("Povrsina kruga je: " + circle1.getArea());
		System.out.println("Obim kruga je: " + circle1.getPerimeter());
		System.out.println("Krug sadrzi tacku 3,3? " + circle1.contains(3, 3));
		System.out.println("Krug sadrzi krug ciji je centar u tacki 4,5 a poluprecnik 10.5? " + circle1.contains(new Circle2D(4, 5, 10.5)));
		System.out.println("Krug se ukrsta sa krugom ciji je centar u tacki 3,5 a poluprecnik 2.3? " + circle1.overlaps(new Circle2D(3, 5, 2.3)));
	}

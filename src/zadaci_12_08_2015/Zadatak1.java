...
public class Zadatak1 {
	...
	public static void main(String[] args) {
		...
		Time time = new Time();
		System.out.println("Trenutno vrijeme: " + time.getHour() + ":" + time.getMinute() + ":" + time.getSecond());

		Time time1 = new Time(555550000);
		System.out.println("Uneseni broj milisekundi u satima, minutama i sekundama: " + time1.getHour() + ":" + time1.getMinute() + ":" + time1.getSecond());
